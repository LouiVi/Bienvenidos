...
var appPath = "/sdcard/Bienvenidos";
var curMenu = "Bienvenidos";
var curPage = null;
...
function CreateDrawer()
{
    ...
    var listItems = "Bienvenidos::[fa-home],About::[fa-question-circle],New File::[fa-plus]";
...
function lstMenu_OnTouch( title, body, type, index )
{
    ...
    //Handle page changes.
    curMenu = title;
    if( title=="Bienvenidos" ) ChangePage( home, title );
